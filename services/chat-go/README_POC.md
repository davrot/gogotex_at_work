...
This is the Go implementation of the `chat` service.

Quickstart

- Build: `docker build -t chat-go:local .`
- Run: `docker run -p 8080:8080 -e PORT=8080 chat-go:local`
- Tests: `go test ./...`
...
- `make -C services/chat-go integration`
- `make -C services/chat-go integration-remote`
