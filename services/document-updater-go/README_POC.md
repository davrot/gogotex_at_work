...
This is the Go implementation of the `document-updater` service.

Quickstart

- Build: `docker build -t document-updater-go:local .`
- Run: `docker run -p 8080:8080 -e PORT=8080 document-updater-go:local`
- Tests: `go test ./...`
...
- `make -C services/document-updater-go integration`
- `make -C services/document-updater-go integration-remote`
