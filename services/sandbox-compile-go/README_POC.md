...
This is the Go implementation of the `sandbox-compile` service.

Quickstart

- Build: `docker build -t sandbox-compile-go:local .`
- Run: `docker run -p 8080:8080 -e PORT=8080 sandbox-compile-go:local`
- Tests: `go test ./...`
...
- `make -C services/sandbox-compile-go integration`
- `make -C services/sandbox-compile-go integration-remote`
