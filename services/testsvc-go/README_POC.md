...
This is the Go implementation of the `testsvc` service.

Quickstart

- Build: `docker build -t testsvc-go:local .`
- Run: `docker run -p 8080:8080 -e PORT=8080 testsvc-go:local`
- Tests: `go test ./...`
...
- `make -C services/testsvc-go integration`
- `make -C services/testsvc-go integration-remote`
