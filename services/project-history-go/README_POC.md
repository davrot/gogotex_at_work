...
This is the Go implementation of the `project-history` service.

Quickstart

- Build: `docker build -t project-history-go:local .`
- Run: `docker run -p 8080:8080 -e PORT=8080 project-history-go:local`
- Tests: `go test ./...`
...
- `make -C services/project-history-go integration`
- `make -C services/project-history-go integration-remote`
