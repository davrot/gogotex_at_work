...
This is the Go implementation of the `filestore` service.

Quickstart

- Build: `docker build -t filestore-go:local .`
- Run: `docker run -p 8080:8080 -e PORT=8080 filestore-go:local`
- Tests: `go test ./...`
...
- `make -C services/filestore-go integration`
- `make -C services/filestore-go integration-remote`
