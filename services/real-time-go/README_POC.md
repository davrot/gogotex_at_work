...
This is the Go implementation of the `real-time` service.

Quickstart

- Build: `docker build -t real-time-go:local .`
- Run: `docker run -p 8080:8080 -e PORT=8080 real-time-go:local`
- Tests: `go test ./...`
...
- `make -C services/real-time-go integration`
- `make -C services/real-time-go integration-remote`
