...
This is the Go implementation of the `gen-service` service.

Quickstart

- Build: `docker build -t gen-service-go:local .`
- Run: `docker run -p 8080:8080 -e PORT=8080 gen-service-go:local`
- Tests: `go test ./...`
...
- `make -C services/gen-service-go integration`
- `make -C services/gen-service-go integration-remote`
