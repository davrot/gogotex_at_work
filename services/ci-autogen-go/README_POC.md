...
This is the Go implementation of the `ci-autogen` service.

Quickstart

- Build: `docker build -t ci-autogen-go:local .`
- Run: `docker run -p 8080:8080 -e PORT=8080 ci-autogen-go:local`
- Tests: `go test ./...`
...
- `make -C services/ci-autogen-go integration`
- `make -C services/ci-autogen-go integration-remote`
