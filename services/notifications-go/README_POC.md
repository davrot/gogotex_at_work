...
This is the Go implementation of the `notifications` service.

Quickstart

- Build: `docker build -t notifications-go:local .`
- Run: `docker run -p 8080:8080 -e PORT=8080 notifications-go:local`
- Tests: `go test ./...`
...
- `make -C services/notifications-go integration`
- `make -C services/notifications-go integration-remote`
