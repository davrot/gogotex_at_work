...
This is the Go implementation of the `history-v1` service.

Quickstart

- Build: `docker build -t history-v1-go:local .`
- Run: `docker run -p 8080:8080 -e PORT=8080 history-v1-go:local`
- Tests: `go test ./...`
...
- `make -C services/history-v1-go integration`
- `make -C services/history-v1-go integration-remote`
