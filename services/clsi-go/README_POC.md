...
This is the Go implementation of the `clsi` service.

Quickstart

- Build: `docker build -t clsi-go:local .`
- Run: `docker run -p 8080:8080 -e PORT=8080 clsi-go:local`
- Tests: `go test ./...`
...
- `make -C services/clsi-go integration`
- `make -C services/clsi-go integration-remote`
