...
- Go 1.21 (git-bridge) and Node.js 18+ (web) + net/ssh (golang.org/x/crypto/ssh), system `git` binary (invoked via os/exec), Mongoose 8.x (web), MongoDB 6.x (001-migrate-git-bridge-java-to-go)
